...
![git log before the split](/interactive-rebase-split/lg_before_split.png)
...
![git rebase first screen](/interactive-rebase-split/rebase_first_screen.png)
...
![git rebase first screen 2](/interactive-rebase-split/rebase_first_screen2.png)
...
![git rebase second screen](/interactive-rebase-split/rebase_second_screen.png)
...
![git rebase stopped](/interactive-rebase-split/rebase_stopped_lg.png)
...
![git reset status](/interactive-rebase-split/rebase_reset_status.png)
...
![git rebase diff](/interactive-rebase-split/rebase_git_diff.png)

If we look at the log again at this point we see that the `f3` is gone though.

![git reset lg](/interactive-rebase-split/rebase_reset_lg.png)
...
![git log after the split](/interactive-rebase-split/rebase_after_split_lg.png)
...
![git rebase success](/interactive-rebase-split/rebase_success.png)
...
![git cherry-üick](/interactive-rebase-split/rebase_cherry-pick.png)

We now have the `f3a` commit sitting on top of latest master. Exactly what we wanted!  
![git final history](/interactive-rebase-split/rebase_final_history.png)
