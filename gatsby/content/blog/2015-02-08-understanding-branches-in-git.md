...
![Creating another branch](../assets/images/git-branching-new-branch.svg)
...
![Understanding HEAD](../assets/images/git-branching-head-pointer.svg)
...
![Switching branches](../assets/images/git-branching-head-pointer-2.svg)
...
![Adding a new commit to feature](../assets/images/git-branching-head-pointer-3.svg)
...
![Switching back to master](../assets/images/git-branching-head-pointer-4.svg)
...
![Adding a new commit to master](../assets/images/git-branching-head-pointer-5.svg)
...
![Checking out commits explicitly](../assets/images/git-detached-head-2.svg)
...
![Adding commits to a detached HEAD](../assets/images/git-detached-head-3.svg)
...
![Adding even more](../assets/images/git-detached-head-4.svg)
...
![Giving it a name again](../assets/images/git-detached-head-6.svg)
